...
export class ServiceService {
  ...
  async getActiveServices(): Promise<ServiceItem[]> {
    ...
    const services: ServiceItem[] = [
      ...
      { id: 5, name: 'Carry off Waste',    description: "Carried off, instead of disposed in your can!", image_url: "https://images.unsplash.com/photo-1517849845537-4d257902454a?q=80&w=400&auto=format&fit=crop" , price: 12, is_addon: true  },
